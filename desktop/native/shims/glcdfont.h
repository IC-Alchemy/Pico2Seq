#pragma once
// Classic Adafruit_GFX 5x7 font (glcdfont), from Adafruit_GFX_Library (BSD).
// Copied for the desktop shim so OLED text renders identically.
#ifndef P2S_GLCDFONT_H
#define P2S_GLCDFONT_H
...
static const unsigned char p2s_glcdfont[] = {
