...
- **Effects Processing**: Per-voice overdrive distortion, followed by a master-bus analog-style delay and compressor. Fader 2 sets delay mix (Shift: time); fader 3 sets master volume (Shift: Warm/Glue/Punch compressor macro).
