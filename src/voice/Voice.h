...
namespace VoicePresets {
   ...
   * @return VoiceConfig Analog voice configuration with warm oscillators and moderate filtering
   */
  VoiceConfig getAnalogVoice();

  /**
   * @brief Get digital-style voice configuration (current Voice 2)
   * @return VoiceConfig Digital voice configuration with bright oscillators and sharp filtering
   */
  VoiceConfig getDigitalVoice();

  /**
   * @brief Get bass voice configuration
   * @return VoiceConfig Bass voice configuration optimized for low-frequency content
   */
  VoiceConfig getBassVoice();

  /**
   * @brief Get lead voice configuration
   * @return VoiceConfig Lead voice configuration optimized for melodic content
   */
  VoiceConfig getLeadVoice();

  /**
   * @brief Get square voice configuration
   * @return VoiceConfig Square voice configuration with sharp and biting character
   */
  VoiceConfig getSquareVoice();

  /**
   * @brief Get pad voice configuration
   * @return VoiceConfig Pad voice configuration with soft attack and ambient character
   */
  VoiceConfig getPadVoice();

  /**
   * @brief Get percussion voice configuration
   * @return VoiceConfig Percussion voice configuration with fast attack and short decay
   */
   ...
   * @return const char* Name of the preset (null-terminated string)
   */
   ...
   * @return uint8_t Number of presets (currently 7)
   */
