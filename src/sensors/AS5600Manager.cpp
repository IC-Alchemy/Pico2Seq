...
void updateAS5600StepParameterValues(UIState& uiState) {
  ...
  Sequencer& activeSequencer = (uiState.selectedVoiceIndex == 0) ? seq1 :
...
float calculateAS5600BoundaryProximity(AS5600ParameterMode param) {
  ...
  float value = 0.0f;
  switch (param) {
    case AS5600ParameterMode::Velocity:      value = activeBaseValues->velocity; break;
    case AS5600ParameterMode::Filter:        value = activeBaseValues->filter; break;
    case AS5600ParameterMode::Attack:        value = activeBaseValues->attack; break;
    case AS5600ParameterMode::Decay:         value = activeBaseValues->decay; break;
    case AS5600ParameterMode::DelayTime:     value = activeBaseValues->delayTime; break;
    case AS5600ParameterMode::DelayFeedback: value = activeBaseValues->delayFeedback; break;
    case AS5600ParameterMode::SlideTime:     value = activeBaseValues->slideTime; break;
    case AS5600ParameterMode::Note:          value = 0.0f; break; // Not stored in base values
    default: break;
  }
