// usb_descriptors.cpp — USB MIDI 2.0 descriptors for tusb_ump (RP2350)
//
// Adapted from the tusb_ump T-PicoC3 example (MIT).
//
...
void usb_descriptors_begin(void) {
  ...
  TinyUSBDevice.setManufacturerDescriptor("MagEncoder");
  TinyUSBDevice.setProductDescriptor("AS5600 MIDI 2.0 HiRes Knob");
  TinyUSBDevice.setSerialDescriptor("AS5600-MIDI2-001");
  TinyUSBDevice.addStringDescriptor("MIDI Streaming");  // index 4
  TinyUSBDevice.addStringDescriptor("Knob");            // index 5
